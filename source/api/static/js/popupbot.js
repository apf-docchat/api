    ...
    const handleVoiceStart = () => {
      navigator.mediaDevices.getUserMedia({ audio: true }).then((stream) => {
        ...
        mediaRecorder.onstop = async () => {
          ...
          // Send message to backend
          setWaitingForResponse(true);
          const response2 = await fetch(`${apiUrl}/text`, {
            method: "POST",
            body: formData2,
          });
          ...
          setMessages([
            ...messages,
            newMessage,
            { type: "bot", text: data2.ai_message, handouts: data2.handouts, media: data2.media },
          ]);
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            // React.createElement("p", null, options.title || "OutScore Bot"),
            React.createElement(Button, {
                ...
                React.createElement(
                  ...
                  React.createElement("p", {
                    ...
                    dangerouslySetInnerHTML: { 
                      __html: msg.text.includes("<") ? msg.text : marked.parse(msg.text) 
                    },
                  }),
...
console.log("commencing outscore...");
var clientId = myScriptData.clientId;

const baseUrl = myScriptData.API_BASE_URL || "https://api.outscore.ai";
